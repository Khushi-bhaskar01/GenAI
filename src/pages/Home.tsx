...
const Home: React.FC = () => {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-black/10 text-white">
      ...
      {/* Wavy section */}
      <section className="relative z-10 flex flex-col  items-center justify-between max-w-7xl mx-auto px-6 pt-20">
        <div className="flex-1 space-y-6 justify-between items-center text-center">
          <motion.h1
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1 }}
            className=" sm:text-3xl lg:text-6xl  font-bold leading-tight audiowide-regular"
          >
          ...
          <motion.p
            ...
            className="text-gray-400 sm:text-lg text-sm max-w-lg m-auto gugi-regular"
          >
            ...
            {[
              {
                ...
                desc: "Tell us about your skills & interests",
                icon: <Rocket className="w-8 h-8 text-blue-400" />,
              },
              {
                step: "Step 2",
                label: "Face The Test",
                desc: "Take the smart AI-powered assessment",
                icon: <ClipboardCheck className="w-8 h-8 text-blue-400" />,
              },
              {
                step: "Step 3",
                label: "The Path Revealed",
                desc: "Get your personalized career roadmap",
              ...
              >
                <div className="flex flex-col items-center gap-3">
                  <div className="p-3 bg-blue-500/10 rounded-full border border-blue-500/30 group-hover:scale-110 transition-transform duration-300">
                    {item.icon}
                  </div>
