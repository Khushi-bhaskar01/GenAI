...
const LoginPage: React.FC = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen flex items-center justify-center px-4 py-2 z-20 inset-0 fixed mt-8">
        <ShootingStarsAndStarsBackgroundDemo />
        
        {/* Main Login Form */}
        {!showForgotPassword && (
          <div className="w-full max-w-md bg-black/20 backdrop-blur-md border border-white/10 shadow-lg rounded-lg px-8 py-4">
            {/* Logo */}
