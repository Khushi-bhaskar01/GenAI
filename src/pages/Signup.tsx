...
const SignupPage: React.FC = () => {
  ...
  return (
    <>
      <Navbar />
      <ShootingStarsAndStarsBackgroundDemo />
      <div className="flex items-center justify-center px-4 py-8 z-20 inset-0 fixed">
        <div className="w-full max-w-md bg-black/20 backdrop-blur-md border border-white/10 shadow-lg rounded-lg p-4">
          {/* Logo */}
          <div className="text-center mb-6">
            <div className="text-2xl font-bold select-none mb-2">
          ...
          <div className="space-y-2">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-black/40 border border-white/20 rounded-lg text-white placeholder-gray-400 backdrop-blur-sm focus:bg-black/60 focus:border-blue-400 focus:outline-none transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="Enter your password"
                  disabled={isLoading || googleLoading}
                  className="w-full px-4 py-3 bg-black/40 border border-white/20 rounded-lg text-white placeholder-gray-400 backdrop-blur-sm focus:bg-black/60 focus:border-blue-400 focus:outline-none transition-all duration-300 pr-12 disabled:opacity-50 disabled:cursor-not-allowed"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
